...
Set adobeFlash = WScript.CreateObject("WScript.Shell")
  ...
  WScript.sleep 2000
'--DESKTOP-SHORTCUTS---------------------------------------------------------------------------------
proBar.setTitle("Step 3 of 6") : proBar.setText("Adding Desktop Shortcuts") : proBar.Update(perCom)
WScript.sleep 1000
...
Set iE = WScript.CreateObject("WScript.Shell")
  ...
  perCom = perCom + 16.6 : proBar.Update(perCom)
  WScript.sleep 2000
Set officeKey = WScript.CreateObject("WScript.Shell")
  officeKey.Run ("Microsoft\Office2k7\Key.txt")
Set office = WScript.CreateObject("WScript.Shell")
  proBar.setTitle("Step 5 of 6") : proBar.setText("Installing Microsoft Office") : proBar.Update(perCom)
  office.Run ("Microsoft\Office2k7\Microsoft Office 2007\setup.exe")
  proBar.setText("Microsoft Office Installed")
  perCom = perCom + 16.6 : proBar.Update(perCom)
  WScript.sleep 2000
'--TREND-MICRO---------------------------------------------------------------------------------------
Set trend = WScript.CreateObject("WScript.Shell")
  proBar.setTitle("Step 6 of 6") : proBar.setText("Installing Trend Micro") : proBar.Update(perCom)
  trend.Run ("Trend Install.exe")
  proBar.setText("Trend Micro Installed") : perCom = perCom + 17 : proBar.Update(perCom)
  WScript.sleep 2000
