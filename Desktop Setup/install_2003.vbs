...
Set adobeReader = WScript.CreateObject("WScript.Shell")
  proBar.setTitle("Step 1 of 8") : proBar.setText("Installing Adobe Reader") : proBar.Update(perCom)
  adobeReader.Run ("Adobe\Reader Installer.exe")
  proBar.setText("Adobe Reader Installed")
  perCom = perCom + 12.5 : proBar.Update(perCom)
  WScript.sleep 2000
Set adobeFlash = WScript.CreateObject("WScript.Shell")
  proBar.setTitle("Step 2 of 8") : proBar.setText("Installing Adobe Flash Player") : proBar.Update(perCom)
  adobeFlash.Run ("Adobe\Flash.exe")
  proBar.setText("Adobe Flash Player Installed")
  perCom = perCom + 12.5 : proBar.Update(perCom)
  WScript.sleep 2000
'--DESKTOP-SHORTCUTS---------------------------------------------------------------------------------
proBar.setTitle("Step 3 of 8") : proBar.setText("Adding Desktop Shortcuts") : proBar.Update(perCom)
WScript.sleep 1000
...
Set iE = WScript.CreateObject("WScript.Shell")
  proBar.setTitle("Step 4 of 8") : proBar.setText("Installing Internet Explorer 7") : proBar.Update(perCom)
  iE.Run ("Microsoft\IE Install.exe")
  proBar.setText("Internet Explorer 7 Installed")
  perCom = perCom + 12.5 : proBar.Update(perCom)
  WScript.sleep 2000
Set office = WScript.CreateObject("WScript.Shell")
  proBar.setTitle("Step 5 of 8") : proBar.setText("Installing Microsoft Office") : proBar.Update(perCom)
  office.Run ("Microsoft\Office2k3\VL-installer\setup.exe")
  proBar.setText("Microsoft Office Installed")
  perCom = perCom + 12.5 : proBar.Update(perCom)
  WScript.sleep 2000
Set servicePack = WScript.CreateObject("WScript.Shell")
  proBar.setTitle("Step 6 of 8") : proBar.setText("Installing Microsoft Office SP3") : proBar.Update(perCom)
  servicePack.Run ("Microsoft\Office2k3\Office2k3 SP3.exe")
  proBar.setText("Microsoft Office SP3 Installed")
  perCom = perCom + 12.5 : proBar.Update(perCom)
  WScript.sleep 2000
Set converter = WScript.CreateObject("WScript.Shell")
  proBar.setTitle("Step 7 of 8") : proBar.setText("Installing Microsoft Office Converter") : proBar.Update(perCom)
  converter.Run ("Microsoft\Office2k3\Office 2007 Converter.exe")
  proBar.setText("Microsoft Office Converter Installed")
  perCom = perCom + 12.5 : proBar.Update(perCom)
  WScript.sleep 2000
'--TREND-MICRO---------------------------------------------------------------------------------------
Set trend = WScript.CreateObject("WScript.Shell")
  proBar.setTitle("Step 8 of 8") : proBar.setText("Installing Trend Micro") : proBar.Update(perCom)
  trend.Run ("Trend Install.exe")
  proBar.setText("Trend Micro Installed") : perCom = perCom + 12.5 : proBar.Update(perCom)
  WScript.sleep 2000
'--INSTALLATION-COMPLETE-----------------------------------------------------------------------------
proBar.setTitle("Step - of 8") : proBar.setText("Installation Complete") : proBar.Update(perCom)
WScript.sleep 1500
proBar.Close()
